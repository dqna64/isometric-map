import { cells } from "./large_state";
import { AssetJSON, AssetJSONWithImageEl, WorldMapJSON } from "./types";
...
export const assets: AssetJSONWithImageEl[] = [
    {
